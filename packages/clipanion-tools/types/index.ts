...
export type CommandSpec = { primaryPath: Array<string>, aliases: Array<Array<string>>, category: string | null, description: string | null, details: string | null, examples: Array<Example>, components: Array<Component>, requiredOptions: Array<number>, };
