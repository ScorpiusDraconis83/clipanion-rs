...
export type CommandSpec = { category: string | null, description: string | null, details: string | null, paths: Array<Array<string>>, components: Array<Component>, requiredOptions: Array<number>, };
